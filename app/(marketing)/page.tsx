  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      >
        ...
        home offices, with EZFlow. Streamline collaboration, project management,
        and achieve new levels of productivity. Maximize your team&apos;s
        potential with EZFlow.
      </div>
      <Button size="lg" asChild className="mt-6">
        <Link href="sign-up">Get EZFlow for Free</Link>
      </Button>
    </div>
  );
}
